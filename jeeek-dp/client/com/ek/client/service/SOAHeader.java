...
@XmlRootElement(name = "SOAHeader", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/")
public class SOAHeader {

    @XmlElement(name = "Responsibility", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/")
    protected String responsibility;
    @XmlElement(name = "RespApplication", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/")
    protected String respApplication;
    @XmlElement(name = "SecurityGroup", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/")
    protected String securityGroup;
    @XmlElement(name = "NLSLanguage", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/")
    protected String nlsLanguage;
    @XmlElement(name = "Org_Id", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/")
