...
/**
 * <p>APPS.CP_MDM_SDH_GET_X2070086X1X25 complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="APPS.CP_MDM_SDH_GET_X2070086X1X25">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ADDRESS_ID" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="STATUS" type="{http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/}string6" minOccurs="0"/>
 ...
 *         &lt;element name="REGION" type="{http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/}string80" minOccurs="0"/>
 ...
 *         &lt;element name="ADDRESS" type="{http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/}string240" minOccurs="0"/>
...
@XmlType(name = "APPS.CP_MDM_SDH_GET_X2070086X1X25", propOrder = {
    "suppliername",
    "suppliercode",
    "addressid",
    "status",
...
public class APPSCPMDMSDHGETX2070086X1X25 {
    ...
    @XmlElementRef(name = "ADDRESS_ID", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> addressid;
    @XmlElementRef(name = "STATUS", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "REGION", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "ADDRESS", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/", type = JAXBElement.class)
     ...
     *     
     */
    public JAXBElement<BigDecimal> getADDRESSID() {
        return addressid;
    }
     ...
     *     
     */
    public void setADDRESSID(JAXBElement<BigDecimal> value) {
