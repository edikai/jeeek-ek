...
/**
 * <p>APPS.CP_MDM_SDH_GETX2070086X1X169 complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="APPS.CP_MDM_SDH_GETX2070086X1X169">
 *   &lt;complexContent>
 ...
 *         &lt;element name="PAYMENT_TERM" type="{http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/}string50" minOccurs="0"/>
 *         &lt;element name="PAY_CURRENCY" type="{http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/}string15" minOccurs="0"/>
 *         &lt;element name="LIABILITY_ACCOUNT" type="{http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/}string150" minOccurs="0"/>
 *         &lt;element name="PREPAY_ACCOUNT" type="{http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/}string150" minOccurs="0"/>
...
@XmlType(name = "APPS.CP_MDM_SDH_GETX2070086X1X169", propOrder = {
    "suppliername",
    "suppliercode",
    "orgname",
    "orgcode",
...
public class APPSCPMDMSDHGETX2070086X1X169 {
    ...
    @XmlElementRef(name = "PAYMENT_TERM", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/", type = JAXBElement.class)
    protected JAXBElement<String> paymentterm;
    @XmlElementRef(name = "PAY_CURRENCY", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/", type = JAXBElement.class)
    protected JAXBElement<String> paycurrency;
    @XmlElementRef(name = "LIABILITY_ACCOUNT", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/", type = JAXBElement.class)
    protected JAXBElement<String> liabilityaccount;
    @XmlElementRef(name = "PREPAY_ACCOUNT", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/", type = JAXBElement.class)
    protected JAXBElement<String> prepayaccount;
     ...
     *     
     */
    public JAXBElement<String> getLIABILITYACCOUNT() {
     ...
     *     
     */
    public void setLIABILITYACCOUNT(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<String> getPREPAYACCOUNT() {
     ...
     *     
     */
    public void setPREPAYACCOUNT(JAXBElement<String> value) {
