...
/**
 * <p>APPS.CP_MDM_SDH_GETX2070086X1X229 complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="APPS.CP_MDM_SDH_GETX2070086X1X229">
 *   &lt;complexContent>
 ...
 *         &lt;element name="VAT_RATE" type="{http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/}string30" minOccurs="0"/>
 *         &lt;element name="VAT_TYPE" type="{http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/}string30" minOccurs="0"/>
 *         &lt;element name="EFFECITIVE_START_DATE" type="{http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/}string28" minOccurs="0"/>
 *         &lt;element name="EFFECITIVE_END_DATE" type="{http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/}string28" minOccurs="0"/>
...
@XmlType(name = "APPS.CP_MDM_SDH_GETX2070086X1X229", propOrder = {
    "suppliername",
    "suppliercode",
    "orgname",
    "orgcode",
...
public class APPSCPMDMSDHGETX2070086X1X229 {
    ...
    @XmlElementRef(name = "VAT_RATE", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/", type = JAXBElement.class)
    protected JAXBElement<String> vatrate;
    @XmlElementRef(name = "VAT_TYPE", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/", type = JAXBElement.class)
    protected JAXBElement<String> vattype;
    @XmlElementRef(name = "EFFECITIVE_START_DATE", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/", type = JAXBElement.class)
    protected JAXBElement<String> effecitivestartdate;
    @XmlElementRef(name = "EFFECITIVE_END_DATE", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/", type = JAXBElement.class)
    protected JAXBElement<String> effecitiveenddate;
     ...
     *     
     */
    public JAXBElement<String> getVATRATE() {
        return vatrate;
    }
     ...
     *     
     */
    public void setVATRATE(JAXBElement<String> value) {
        this.vatrate = value;
    }
     ...
     *     
     */
    public JAXBElement<String> getEFFECITIVESTARTDATE() {
        return effecitivestartdate;
    }

    /**
     * 设置effecitivestartdate属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setEFFECITIVESTARTDATE(JAXBElement<String> value) {
        this.effecitivestartdate = value;
    }

    /**
     * 获取effecitiveenddate属性的值。
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getEFFECITIVEENDDATE() {
        return effecitiveenddate;
    }

    /**
     * 设置effecitiveenddate属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setEFFECITIVEENDDATE(JAXBElement<String> value) {
        this.effecitiveenddate = value;
    }
