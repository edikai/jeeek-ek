...
/**
 * <p>APPS.CP_MDM_SDH_GET_DX2070086X1X6 complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="APPS.CP_MDM_SDH_GET_DX2070086X1X6">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ADDR_CONT_ID" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
...
@XmlType(name = "APPS.CP_MDM_SDH_GET_DX2070086X1X6", propOrder = {
    "suppliername",
    "suppliercode",
    "linkman",
    "addrcontid",
...
public class APPSCPMDMSDHGETDX2070086X1X6 {
    ...
    @XmlElementRef(name = "ADDR_CONT_ID", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cp_mdm_sdh_get_data_pkg2/export_cp_sdh_info/", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> addrcontid;
     ...
     *     
     */
    public JAXBElement<BigDecimal> getADDRCONTID() {
        return addrcontid;
    }
     ...
     *     
     */
    public void setADDRCONTID(JAXBElement<BigDecimal> value) {
        this.addrcontid = value;
    }
